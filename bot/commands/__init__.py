...
from .message import MessageCommand as Message
...
#from .reg_mode import RegCommand as Change
#from .psy_mode import PsyCommand as PsyMood
#from .pravo_mode import PravoCommand as PravoMode
